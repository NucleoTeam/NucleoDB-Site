    ...
    return (
        <main className="flex min-h-screen flex-col items-center p-24">
            <div className="z-10 max-w-5xl w-full items-center justify-between font-mono text-sm lg:flex">
                ...
                <div className="topMenu fixed bottom-0 left-0 flex h-48 w-full items-end justify-center bg-gradient-to-t from-white via-white dark:from-black dark:via-black lg:static lg:h-auto lg:w-auto lg:bg-none">
            ...
            <div className="mb-32 mt-5 grid text-center lg:max-w-5xl lg:w-full lg:mb-0 lg:grid-cols-3 lg:text-left">
                ...
                >
                    ...
                    <p className={`m-4 max-w-[30ch] text-sm opacity-50`}>
                        <Image width={600} height={400} src={"/sites/animecap.png"} alt={""}/>
